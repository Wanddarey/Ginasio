...
namespace BusinessLogicLayer
{
    public class BLL
    {
        ...
        public class Funcionarios
        {
            ...
            static public int insertFuncionario(string nome, string password, string dtn, string telefone, string posicao)
            {
                DAL dal = new DAL();
                SqlParameter[] sqlParams = new SqlParameter[]{
                new SqlParameter("@nome", nome),
            ...
            static public DataTable queryfuncionario(string nome, string password)
            {
                DAL dal = new DAL();
                SqlParameter[] sqlParams = new SqlParameter[]{
                new SqlParameter("@nome", nome),
